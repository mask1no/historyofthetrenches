...
export function Footer() {
  return (
    <footer className="border-t border-border/40 bg-card dark:border-white/[0.04]">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10">
        <div className="relative overflow-hidden rounded-2xl border border-border/40 bg-card p-6 shadow-subtle dark:border-white/[0.04]">
        ...
        <div className="hidden gap-4 md:grid md:grid-cols-3">
          <div className="rounded-xl border border-border/40 bg-card p-4 shadow-subtle dark:border-white/[0.04]">
        ...
        <div className="flex flex-col gap-2 border-t border-border/40 pt-4 text-xs text-muted dark:border-white/[0.04] sm:flex-row sm:items-center sm:justify-between">
